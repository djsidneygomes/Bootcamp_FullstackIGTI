...
/*funcionalidade que o backend não tem
que é validar as notas*/
...
async function getAllGrades() {
  ...
  let allStudents = new Set(); //estrutura que simula conjunto
  ...
  allCombinations.forEach(({ student, subject, type }) => {
    ///verifica se todos os campos estão na API
